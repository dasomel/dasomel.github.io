    ...
    <footer className="mt-auto border-t" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--surface)' }}>
      <div className="mx-auto grid max-w-[1440px] gap-8 px-5 py-9 sm:px-8 md:grid-cols-[1fr_auto] md:items-end lg:px-16">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Link href="/ko/docs" className="rounded-lg border px-3 py-2 font-mono text-[10px] transition-colors hover:bg-[var(--surface-hi)]" style={{ color: 'var(--text-muted)', borderColor: 'var(--border)' }}>DOCS</Link>
          <Link href="/ko/tech-digest" className="rounded-lg border px-3 py-2 font-mono text-[10px] transition-colors hover:bg-[var(--surface-hi)]" style={{ color: 'var(--text-muted)', borderColor: 'var(--border)' }}>DIGEST</Link>
          <Link href="/ko/events" className="rounded-lg border px-3 py-2 font-mono text-[10px] transition-colors hover:bg-[var(--surface-hi)]" style={{ color: 'var(--text-muted)', borderColor: 'var(--border)' }}>EVENTS</Link>
          ...
          <a href="/rss.xml" className="rounded-lg border p-2 transition-colors hover:bg-[var(--surface-hi)]" aria-label="RSS" style={{ color: 'var(--text-faint)', borderColor: 'var(--border)' }}><Rss className="h-4 w-4" /></a>
        </div>
      </div>
    </footer>
  );
