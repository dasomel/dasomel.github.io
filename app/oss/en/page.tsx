    ...
    <div className="mx-auto max-w-[1180px] px-5 py-14 sm:px-7 lg:py-20" style={{ color: 'var(--text)' }}>
      ...
      <section className="mt-8 rounded-3xl p-7 sm:p-9" style={{ border: '1px solid var(--accent)', backgroundColor: 'var(--surface)' }}>
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="max-w-3xl"><div className="text-xs font-semibold uppercase tracking-[0.16em]" style={{ color: 'var(--accent)' }}>Start here</div><h2 className="mt-2 text-2xl font-semibold sm:text-3xl">Why were these OSS projects built?</h2><p className="mt-3 text-sm leading-7 sm:text-base" style={{ color: 'var(--text-muted)' }}>From market signals and Kubernetes platform complexity to OSS adoption, OpenForge insight standardization, and Narwhal’s role in the portfolio.</p></div>
          <Link href="/oss/story/" className="inline-flex shrink-0 items-center justify-center rounded-full px-5 py-3 text-sm font-semibold" style={{ backgroundColor: 'var(--accent)', color: 'var(--accent-fg)' }}>View OSS Story →</Link>
        </div>
      </section>
