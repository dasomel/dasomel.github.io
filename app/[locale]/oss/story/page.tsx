    ...
    <main>
      ...
      <section className="border-b" style={{borderColor:'var(--border)'}}>
        <div className="mx-auto max-w-[1440px] px-5 py-12 sm:px-8 lg:px-16 lg:py-16">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-3 rounded-2xl p-4 sm:max-w-5xl" style={{border:'1px solid var(--border)',backgroundColor:'var(--surface-hi)'}}><span className="font-mono text-[10px] font-semibold uppercase tracking-[0.12em]" style={{color:'var(--signal)'}}>CONTEXT</span><span className="text-sm" style={{color:'var(--text-muted)'}}>{en?'Use the rationale page for the OSS practice, and the evidence page for measurable development signals.':'OSS를 만드는 이유는 Why OSS에서, 실제 개발 지속성과 릴리스·활동 신호는 Evidence에서 확인할 수 있습니다.'}</span><Link href={`/${currentLocale}/oss/why/`} className="text-sm font-semibold" style={{color:'var(--accent)'}}>Why OSS →</Link><Link href={`/${currentLocale}/oss/evidence/`} className="text-sm font-semibold" style={{color:'var(--signal)'}}>Evidence →</Link></div>
        </div>
      </section>
