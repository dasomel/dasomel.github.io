...
After installing K-PaaS Lite, you'll have access to the Container Platform Portal shown below.

![Portal Demo](/images/kpaas/portal.gif)

## Installation Process

![Installation Process](/images/kpaas/process.png)
...
![Vagrant Log](/images/kpaas/log_vagrant.gif)

### Platform Log

![Platform Log](/images/kpaas/log_platform.gif)
