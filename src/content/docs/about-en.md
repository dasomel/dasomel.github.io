...
### 1. Easy Installation
- Automated installation process based on Vagrant
- Build entire cluster with a single command
- Ready to use immediately without complex configuration
...
- Provides core features of K-PaaS Container Platform
- Same structure as actual production environment
- Perfect for development/testing/demo environments

## Official K-PaaS Project

K-PaaS is a Korean open cloud platform supported by the National Information Society Agency (NIA).

- [K-PaaS Official Website](https://k-paas.or.kr/intro/history)
- Apache License 2.0 open source
- CNCF Kubernetes certified

![CNCF Certification](/images/kpaas/cncf_certification_k-paas.png)
