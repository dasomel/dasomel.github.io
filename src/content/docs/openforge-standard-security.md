...
Source code, dependencies, CI runners, generated artifacts, release credentials, deployment targets, and external tools are separate trust domains. Crossing a boundary requires validation or isolation appropriate to the risk.

## Risk-based governance

Controls should be strong enough to reduce material risk without making single-maintainer OSS impossible to operate. Automation is preferred where repeatability matters.
